    ...
    return (
      <div className="min-h-screen bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-12">Find the right plan for magical bedtime stories</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="border border-gray-200 rounded-2xl p-6 shadow-sm">
            ...
            <p className="text-gray-600 mb-4">Perfect for casual dreamers. Always free.</p>
            <p className="text-3xl font-bold text-gray-900 mb-6">$0<span className="text-base font-normal text-gray-500">/week</span></p>
          ...
          <div className="border border-blue-600 rounded-2xl p-6 shadow-md bg-blue-50">
            ...
            <p className="text-blue-700 mb-4">For little dreamers who want more magic</p>
            <p className="text-3xl font-bold text-blue-900 mb-6">$5<span className="text-base font-normal text-blue-600">/week</span></p>
